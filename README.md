...
| US16 | Experiencia del usuario en la app | Acceso diferenciado | Como usuario, quiero seleccionar si ingreso como pasajero o empresa de transporte, para acceder a la versión de la plataforma que corresponde a mis necesidades. | **Escenario positivo: Acceso correcto según tipo de usuario**<br><br>**Dado** que el usuario está en la pantalla inicial, **cuando** selecciona “Pasajero”, **entonces** la plataforma lo dirige al flujo de uso para pasajeros. <br> <br> **Dado** que el usuario selecciona “Empresa de Transporte”, **cuando** confirma el tipo de acceso, **entonces** la plataforma lo dirige al módulo empresarial.<br><br> **Escenario negativo: No selecciona un tipo de usuario**<br><br>**Dado** que el usuario no ha elegido ninguna opción,  **cuando** intenta continuar,  **entonces** aparece el mensaje “Seleccione un tipo de usuario para continuar”.  |
| US17 | Administración de flota | Acceso para empresas | Como empresa de transporte, quiero acceder a un módulo web exclusivo, para visualizar funcionalidades específicas como monitoreo de buses, alertas y reportes.  | **Escenario positivo: Visualización de contenido empresarial**<br><br>**Dado** que la empresa ingresa al módulo, **cuando** revisa la sección “Monitoreo”, **entonces** observa las opciones para ver buses activos y alertas.<br><br> **Escenario negativo: Ruta no disponible**<br><br>**Dado** que ocurre un error de carga, **cuando** la empresa intenta acceder al módulo, **entonces** la plataforma muestra el mensaje “Módulo no disponible, intente más tarde”.|

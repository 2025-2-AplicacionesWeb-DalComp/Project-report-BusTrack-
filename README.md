...
A partir de estas épicas se han identificado un conjunto de **17 User Stories funcionales**, asociadas a los usuarios principales del sistema. Estas historias describen las interacciones clave que los usuarios deberán realizar dentro de la aplicación y permiten establecer el alcance funcional del producto.
...
|------|---------|------------------------------|--------|--------------------------------------------------------------------------------------------------|--------------------------|
| US01 | E01 | Gestión de rutas y horarios  | Buscar rutas | Como pasajero, quiero buscar una ruta en el mapa para encontrar la mejor opción de transporte. | **Positivo:** <br> **Dado** que ingreso origen y destino válidos, **cuando** hago clic en “Buscar ruta”, **entonces** se muestran las rutas disponibles. <br><br> **Negativo:** <br> **Dado** que ingreso un destino inválido, **cuando** busco la ruta, **entonces** aparece “Ruta no encontrada”. |
| US02 | E01 | Gestión de rutas y horarios  | Visualizar horarios | Como pasajero, quiero visualizar el horario del próximo bus para organizar mi tiempo. | **Positivo:** <br> **Dado** que selecciono una ruta válida, **cuando** abro “Ver horarios”, **entonces** veo el horario del próximo bus. <br><br> **Negativo:** <br> **Dado** que la ruta no tiene horarios disponibles, **cuando** intento verlos, **entonces** aparece “Horarios no disponibles”. |
| US03 | E01 | Gestión de rutas y horarios  | Guardar rutas frecuentes | Como pasajero, quiero guardar mis rutas frecuentes para acceder a ellas rápidamente. | **Positivo:** <br> **Dado** que selecciono una ruta, **cuando** presiono “Guardar como favorita”, **entonces** la ruta se guarda exitosamente. <br><br> **Negativo:** <br> **Dado** que la ruta ya está guardada, **cuando** intento guardarla nuevamente, **entonces** aparece “Esta ruta ya está guardada”. |
| US04 | E02 | Monitoreo en tiempo real     | Ver ubicación del bus | Como pasajero, quiero ver la ubicación del bus en el mapa para saber cuánto tardará. | **Positivo:** <br> **Dado** que el bus está transmitiendo GPS, **cuando** abro la ruta, **entonces** la ubicación se muestra en el mapa. <br><br> **Negativo:** <br> **Dado** que el bus no tiene señal GPS, **cuando** abro la ruta, **entonces** aparece “Ubicación no disponible”. |
| US05 | E02 | Monitoreo en tiempo real     | Notificaciones de retraso | Como pasajero, quiero recibir notificaciones de retraso para ajustar mi viaje. | **Positivo:** <br> **Dado** que el retraso supera 10 minutos, **cuando** ocurre, **entonces** la app me envía una notificación. <br><br> **Negativo:** <br> **Dado** que desactivé notificaciones, **cuando** ocurre un retraso, **entonces** no recibo alertas. |
| US06 | E02 | Monitoreo en tiempo real     | Alertas de desvío | Como pasajero, quiero recibir alertas si el bus cambia su ruta. | **Positivo:** <br> **Dado** un desvío registrado, **cuando** el sistema actualiza la ruta, **entonces** recibo una alerta. <br><br> **Negativo:** <br> **Dado** que no tengo conexión, **cuando** ocurre un desvío, **entonces** no recibo notificaciones. |
| US07 | E03 | Administración de flota      | Monitorear buses | Como administrador de flota, quiero monitorear mis buses en tiempo real. | **Positivo:** <br> **Dado** que los buses están operativos, **cuando** abro el panel, **entonces** veo el estado de cada unidad. <br><br> **Negativo:** <br> **Dado** que hay un error del servidor, **cuando** accedo al panel, **entonces** aparece “Error de conexión”. |
| US08 | E03 | Administración de flota      | Generar reportes diarios | Como administrador de flota, quiero generar reportes para evaluar eficiencia. | **Positivo:** <br> **Dado** que solicito “Generar reporte”, **cuando** el sistema procesa, **entonces** muestra estadísticas de puntualidad. <br><br> **Negativo:** <br> **Dado** que el servidor está en mantenimiento, **cuando** genero el reporte, **entonces** aparece “No se pudo generar el reporte”. |
| US09 | E03 | Administración de flota      | Configurar alertas | Como administrador, quiero configurar alertas para incidentes de tráfico. | **Positivo:** <br> **Dado** que las alertas están activadas, **cuando** ocurre un incidente, **entonces** recibo una notificación. <br><br> **Negativo:** <br> **Dado** que desactivo alertas, **cuando** ocurre un incidente, **entonces** no recibo notificación. |
| US10 | E04 | Experiencia del usuario      | Registro | Como nuevo pasajero, quiero registrarme para personalizar rutas. | **Positivo:** <br> **Dado** que completo los campos, **cuando** presiono “Registrarse”, **entonces** se crea la cuenta. <br><br> **Negativo:** <br> **Dado** que dejo campos vacíos, **cuando** presiono “Registrarse”, **entonces** aparece “Complete todos los campos”. |
| US11 | E04 | Experiencia del usuario      | Calificar servicio | Como pasajero, quiero calificar mis viajes. | **Positivo:** <br> **Dado** que selecciono un viaje, **cuando** presiono “Calificar”, **entonces** puedo dejar un puntaje y comentario. <br><br> **Negativo:** <br> **Dado** que no seleccioné un viaje, **cuando** intento calificar, **entonces** aparece “Seleccione un viaje realizado”. |
| US12 | E04 | Experiencia del usuario      | Editar perfil | Como pasajero, quiero editar mis datos personales. | **Positivo:** <br> **Dado** que ingreso datos válidos, **cuando** guardo cambios, **entonces** el perfil se actualiza correctamente. <br><br> **Negativo:** <br> **Dado** que ingreso un correo inválido, **cuando** guardo cambios, **entonces** aparece “Correo no válido”. |
| US13 | E05 | Landing Page   | Información de la solución | Como visitante, quiero ver información de la solución para entender su utilidad. | **Positivo:** <br> **Dado** que ingreso al home, **cuando** reviso la sección “Solución”, **entonces** veo un resumen claro. <br><br> **Negativo:** <br> **Dado** que hay un error de carga, **cuando** ingreso al home, **entonces** aparece “Información no disponible”. |
| US14 | E05 | Landing Page   | Beneficios | Como visitante, quiero conocer los beneficios de la aplicación. | **Positivo:** <br> **Dado** acceso a la sección, **cuando** reviso, **entonces** veo al menos tres beneficios. <br><br> **Negativo:** <br> **Dado** contenido incompleto, **cuando** navego, **entonces** aparece “Información en actualización”. |
| US15 | E05 | Landing Page   | Misión y visión | Como visitante, quiero conocer la misión y visión de la empresa. | **Positivo:** <br> **Dado** que ingreso a “Nosotros”, **cuando** reviso la sección, **entonces** veo misión y visión claramente. <br><br> **Negativo:** <br> **Dado** error de carga, **cuando** ingreso, **entonces** aparece “Contenido no disponible”. |
| US16 | E04 | Experiencia del usuario | Acceso diferenciado | Como usuario, quiero elegir si ingreso como pasajero o empresa. | **Positivo:** <br> **Dado** que selecciono un tipo de usuario, **cuando** continúo, **entonces** accedo al módulo correspondiente. <br><br> **Negativo:** <br> **Dado** que no selecciono nada, **cuando** intento continuar, **entonces** aparece “Seleccione un tipo de usuario”. |
| US17 | E03 | Administración de flota | Acceso para empresas | Como empresa, quiero acceder a un módulo exclusivo con funciones avanzadas. | **Positivo:** <br> **Dado** que ingreso correctamente, **cuando** reviso “Monitoreo”, **entonces** veo buses activos y alertas. <br><br> **Negativo:** <br> **Dado** un error de carga, **cuando** ingreso al módulo, **entonces** aparece “Módulo no disponible”. |

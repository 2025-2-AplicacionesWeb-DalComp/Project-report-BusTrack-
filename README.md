...
| Perfil | Alumno |
|--------|-------------|
| ![Mathias Cardenas](img/developers/mathiasCardenas.png) <br>**Figura 1.** Fotografía del integrante Mathias Cardenas. <br>Fuente: elaboración propia.
...
|------|---------|------------------------------|--------|--------------------------------------------------------------------------------------------------|--------------------------|
| US01 | E01 | Gestión de rutas y horarios  | Buscar rutas | Como pasajero, quiero buscar una ruta en el mapa para encontrar la mejor opción de transporte. | **Positivo:** Dado origen y destino válidos, cuando hago clic en “Buscar ruta”, entonces se muestran las rutas disponibles. <br> **Negativo:** Dado que ingreso un destino inválido, cuando busco, entonces aparece “Ruta no encontrada”. |
| US02 | E01 | Gestión de rutas y horarios  | Visualizar horarios | Como pasajero, quiero visualizar el horario del próximo bus para organizar mi tiempo. | **Positivo:** Dado que selecciono una ruta válida, cuando abro “Ver horarios”, entonces veo el horario del próximo bus. <br> **Negativo:** Dado que la ruta no tiene horarios disponibles, cuando intento verlos, entonces aparece “Horarios no disponibles”. |
...
| US04 | E02 | Monitoreo en tiempo real     | Ver ubicación del bus | Como pasajero, quiero ver la ubicación del bus en el mapa para saber cuánto tardará. | **Positivo:** Dado GPS activo, cuando abro la ruta, entonces veo la ubicación en el mapa. <br> **Negativo:** Dado que el bus no tiene señal GPS, cuando abro la ruta, entonces aparece “Ubicación no disponible”. |
| US05 | E02 | Monitoreo en tiempo real     | Notificaciones de retraso | Como pasajero, quiero recibir notificaciones si hay atraso para ajustar mi plan. | **Positivo:** Dado retraso mayor a 10 minutos, cuando ocurre, entonces recibo una notificación. <br> **Negativo:** Dado que desactivé notificaciones, cuando ocurre un retraso, entonces no recibo alertas. |
| US06 | E02 | Monitoreo en tiempo real     | Alertas de desvío | Como pasajero, quiero recibir alertas si un bus cambia de ruta. | **Positivo:** Dado un desvío registrado, cuando la ruta cambia, entonces recibo la alerta. <br> **Negativo:** Dado que no tengo conexión, cuando ocurre el desvío, entonces no recibo notificaciones. |
| US07 | E03 | Administración de flota      | Monitorear buses | Como administrador de flota, quiero monitorear mis buses en tiempo real. | **Positivo:** Dado buses operativos, cuando abro el panel, entonces veo el estado de cada unidad. <br> **Negativo:** Dado error del servidor, cuando accedo, entonces aparece “Error de conexión”. |
| US08 | E03 | Administración de flota      | Configurar alertas internas | Como administrador, quiero configurar alertas para incidentes de tráfico. | **Positivo:** Dado alertas activadas, cuando ocurre un incidente, entonces recibo una notificación. <br> **Negativo:** Dado que desactivo alertas, cuando ocurre un incidente, entonces no recibo notificación. |
...
| US11 | E05 | Landing Page   | Información de la solución | Como visitante, quiero ver información de la solución para entender su utilidad. | **Positivo:** Dado ingreso al home, cuando reviso “Solución”, entonces veo un resumen claro. <br> **Negativo:** Dado error de carga, cuando ingreso, entonces aparece “Información no disponible”. |
| US12 | E05 | Landing Page   | Beneficios | Como visitante, quiero conocer los beneficios de la aplicación. | **Positivo:** Dado acceso a la sección, cuando reviso, entonces veo al menos tres beneficios. <br> **Negativo:** Dado contenido incompleto, cuando navego, entonces aparece “Información en actualización”. |
| US13 | E05 | Landing Page   | Misión y visión | Como visitante, quiero conocer la misión y visión de la empresa. | **Positivo:** Dado ingreso a “Nosotros”, cuando reviso, entonces veo misión y visión claramente. <br> **Negativo:** Dado error de carga, cuando ingreso, entonces aparece “Contenido no disponible”. |
| US14 | E04 | Experiencia del usuario | Acceso diferenciado | Como usuario, quiero elegir si ingreso como pasajero o empresa. | **Positivo:** Dado selección del tipo de usuario, cuando continúo, entonces accedo al módulo correspondiente. <br> **Negativo:** Dado que no selecciono nada, cuando continúo, entonces aparece “Seleccione un tipo de usuario”. |
| US15 | E03 | Administración de flota | Acceso para empresas | Como empresa, quiero acceder a un módulo exclusivo con funciones avanzadas. | **Positivo:** Dado que ingreso correctamente, cuando abro “Monitoreo”, entonces veo buses activos y alertas. <br> **Negativo:** Dado un error de carga, cuando ingreso al módulo, entonces aparece “Módulo no disponible”. |
